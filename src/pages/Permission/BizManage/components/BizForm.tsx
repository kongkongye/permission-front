...
const Index: React.FC<Props> = (props: Props) => {
  ...
  return (
    <>
      <ProDescriptions>
        <ProDescriptions.Item label='父目录' contentStyle={{color: parent?'inherit':'grey'}}>{parent?.name??'无'}</ProDescriptions.Item>
      </ProDescriptions>
      <ProFormText name="id" hidden/>
      <ProFormText name="dirCode" hidden/>
