...
const Index: React.FC<Props> = (props: Props) => {
  ...
  return (
    <>
      <ProDescriptions>
        <ProDescriptions.Item label="权限类型" contentStyle={{ color: type ? 'inherit' : 'grey' }}>
          {type ?? '无'}
        </ProDescriptions.Item>
        <ProDescriptions.Item label="父权限" contentStyle={{ color: parent ? 'inherit' : 'grey' }}>
          {parent?.name ?? '无'}
        </ProDescriptions.Item>
      </ProDescriptions>
      ...
      <ProFormText name="filterCode" hidden />
